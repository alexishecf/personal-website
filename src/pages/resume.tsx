...
import { faFilePdf, faChevronLeft, faFlag } from '@fortawesome/free-solid-svg-icons';
    ...
    <div>
      ...
      <div className="relative bg-white">
        <div className="max-w-6xl mx-auto px-4 h-14 my-4 border-b print:hidden">
          <Link href="/">
            <a className="float-left bg-gray-600 py-2 px-4 rounded-md hover:bg-gray-500 text-white font-bold" href="/">
              <FontAwesomeIcon icon={faChevronLeft}></FontAwesomeIcon>
            </a>
          </Link>

          <div className="float-left py-2">
            <FontAwesomeIcon icon={faFlag} className="ml-4 text-gray-800"></FontAwesomeIcon>
            <Link href="/resume" locale="en-US">
              <a className={`${router.locale === 'en-US' ? 'font-bold' : ''} px-2 text-gray-800`} href="/">
                ENG
              </a>
            </Link>
            <span className="">|</span>
            <Link href="/resume" locale="fr">
              <a className={`${router.locale === 'fr' ? 'font-bold' : ''} px-2 text-gray-800`} href="/">
                FRA
              </a>
            </Link>
          </div>
          <a
            ...
            href={router.locale === 'fr' ? '/files/hecfeuille_resume_fr.pdf' : '/files/hecfeuille_resume.pdf'}>
        ...
        <div className="max-w-4xl print:max-w-5xl mx-auto pr-8 lg:pr-0">
          <div>
            ...
            <div className="inline-block ml-6 mt-7">
              <h1 className="text-3xl font-semibold text-gray-900 tracking-wide">ALEXIS HECFEUILLE</h1>
              ...
              <p className="text-gray-600 text-sm mt-1 tracking-wider">
                ...
                | <a href="mailto:alexis@hecfeuille.fr">alexis@hecfeuille.fr</a> | +33 6 51 19 29 38
                <br />
                <a href="https://github.com/alexishecf" target="_blank">
                  <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon> alexishecf
                </a>{' '}
                /
                <a href="https://linkedin.com/in/alexishecfeuille" target="_blank" className="ml-1">
                  <FontAwesomeIcon icon={faLinkedin}></FontAwesomeIcon> alexishecfeuille
                </a>
              </p>
            </div>
          </div>
          <div>
            <div className="ml-8 lg:ml-28 mt-8 print:ml-10">
              ...
              <div>
                <ul>
                  <li
                    className={` text-gray-400  mt-1 w-24
                      } text-sm  inline-block`}>
                    Languages
                  </li>
                  {['TypeScript', 'JS', 'C#', 'SQL', 'Python', 'Solidity'].map((skill, index) => (
                    <li
                      key={index}
                      className={`border text-indigo-500 px-4 mr-1 mt-1
                      } text-sm border-indigo-200 inline-block`}>
                      {skill}
                    </li>
                  ))}
                </ul>
                <ul>
                  <li
                    className={` text-gray-400 w-24 mt-1
                      }  text-sm  inline-block`}>
                    Outils
                  </li>
                  {['VS Code', 'Git', 'Docker', 'Postman'].map((skill, index) => (
                    <li
                      key={index}
                      className={`border text-indigo-500 px-4 mr-1 mt-1
                      }  text-sm border-indigo-200 inline-block`}>
                ...
                <ul>
                  ...
                  {['Angular', 'Node', 'React', 'PostgreSQL', 'MongoDB', 'Web3', 'Unity'].map((skill, index) => (
                    <li
                      key={index}
                      className={`border text-indigo-500 px-4 mr-1 mt-1
                      }  text-sm border-indigo-200 inline-block`}>
            ...
            <div className="ml-8 lg:ml-28 mt-10 print:ml-10">
              ...
              <div className="experience-list">
                <div className="experience-item">
                  <a href="https://arianee.org/" target="_blank">
                    <h2 className="mt-3 tracking-wider text-gray-900 uppercase text-lg font-semibold">Arianee</h2>
                  </a>
                  <h3 className="mt-1 text-sm text-gray-900 tracking-wider">
                    <FormattedMessage id="resume_workExperience2CompanyDesc" />
                  </h3>

                  <h4 className="text-gray-500 text-sm tracking-wider mt-2">
                    <FormattedMessage id="resume_workExperience2JobTitle" /> | Paris, France | Jan 2022 – Aujourd'hui
                  </h4>
                  <ul className="list-disc ml-5 mt-3 text-gray-900 tracking-wider text-sm ">
                    <li className="py-1">
                      <FormattedMessage id="resume_workExperience2UnorderedListEl1" />
                    </li>
                    <li className="pt-1">
                      <FormattedMessage id="resume_workExperience2UnorderedListEl2" />
                    </li>
                    <li className="pt-1">
                      <p>
                        Amélioration du processus de création de <i>lounge</i> de spkz.io (application de chat web3
                        open-source initiée par Arianee) en développant un validateur de <i>lounge</i> et diverses
                        stratégies (plus des tests) utilisées par les <i>lounges</i>.
                      </p>
                    </li>
                  </ul>
                </div>
                ...
                <div className="experience-item mt-8">
                  <a href="https://hologame.fr/" target="_blank">
                    <h2 className="mt-3 tracking-wider text-gray-900 uppercase text-lg font-semibold">hologame</h2>
                  </a>
                  <h3 className="mt-1 text-sm text-gray-900 tracking-wider">
                  ...
                  <h4 className="text-gray-500 text-sm tracking-wider mt-2">
                    <FormattedMessage id="resume_workExperience1JobTitle" /> | Tourcoing, France | Sep 2018 – Dec 2021
                  </h4>
                  <ul className="list-disc ml-5 mt-3 text-gray-900 tracking-wider text-sm ">
                    <li className="py-1">
            ...
            <div className="ml-8 lg:ml-28 mt-10 print:ml-10">
              ...
              <div className="education-list">
                <div className="education-item">
                  <a href="https://sciences-technologies.univ-lille.fr/informatique/" target="_blank">
                  ...
                  <h3 className="text-gray-600 text-sm tracking-wider mt-1">
                    <FormattedMessage id="resume_education2Diploma" /> | 2019 – 2021
                  </h3>
                  <p className="mt-2 text-sm tracking-wide text-gray-900">
                    Spécialité <i>Image, Vision, Interaction</i> – Mention Bien
                  </p>
                </div>
                <div className="education-item mt-8">
                  ...
                  <h3 className="text-gray-600 text-sm tracking-wider mt-1">
                    <FormattedMessage id="resume_education1Diploma" /> | 2016 – 2019
                  </h3>
                  <p className="mt-2 text-sm tracking-wide text-gray-900">
          ...
          <div>
            <div className="ml-8 lg:ml-28 mt-8 pb-28 print:pb-0 print:ml-10">
